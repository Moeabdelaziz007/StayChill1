  ...
  return (
    <div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900">
        ...
        <div className="container py-12 md:py-16 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h1 className="text-3xl md:text-5xl font-bold mb-4 drop-shadow-md">خدمات ستاي تشيل الاستثنائية</h1>
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-8">
              استمتع بمجموعة متنوعة من الخدمات المميزة التي تجعل إقامتك تجربة لا تُنسى - من أفضل المطاعم إلى أرقى النوادي الليلية والمزيد
            </p>
            ...
            <div className="relative max-w-2xl mx-auto">
              <div className="flex items-center bg-white/10 backdrop-blur-lg border border-white/20 rounded-full p-1.5 pl-5 shadow-lg focus-within:ring-2 focus-within:ring-white/50">
                ...
                <Input
                  placeholder="ابحث عن خدمة مميزة..."
                  value={searchQuery}
      ...
      <div className="container py-8">
        ...
        <div className="bg-white dark:bg-gray-800/80 shadow-md rounded-xl p-4 mb-8 border border-gray-100 dark:border-gray-700">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="md:flex-1">
              <div className="text-sm font-medium mb-2 text-gray-500 dark:text-gray-400">المواقع المميزة</div>
              <Select
        ...
        {/* أنواع الخدمات */}
        <div className="w-full mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">فئات الخدمات المميزة:</div>
        ...
        {selectedServiceType !== "restaurant" && selectedServiceType !== "nightclub" && selectedServiceType !== "all" && (
          <div className="mt-12 p-8 bg-gray-50 rounded-2xl text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
              نعمل حالياً على إضافة هذه الخدمة لتعزيز تجربتك. ترقبوا المزيد من التفاصيل والعروض المميزة قريباً.
            </p>
            <Button 
              variant="outline" 
              onClick={() => setSelectedServiceType("all")}
